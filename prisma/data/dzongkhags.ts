export type DzongkhagRegion = "WEST" | "CENTRAL" | "EAST" | "NORTH" | "SOUTH";
...
// Bhutan's 20 dzongkhags (districts). There's no official 5-way regional
// classification for them — the standard tourism/administrative grouping
// is really the 3-way West/Central/East split. This assigns each
// dzongkhag to a West/Central/East/North/South bucket by its own
// geography (North = the high-Himalaya interior, South = the dzongkhags
// along the India border), for site navigation/browsing only.
